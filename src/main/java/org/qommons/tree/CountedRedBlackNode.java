...
/**
 * A red/black node containing a theValue which also keeps track of the size of the tree structure under each node. This makes insertions and
 ...
 * for both.
 *
 * @param <E> The type of theValue in this node
 */
public abstract class CountedRedBlackNode<E> extends ValuedRedBlackNode<E> {
	...
	/** @param theValue The theValue for the node */
	 ...
	 *
	 * @param <E> The type of theValue for the node
	 */
	...
	/**
	 * A tree set of counted nodes that improves performance for some operations and adds the ability to get the index of a theValue
	 *
	...
	public static abstract class CountedRedBlackTreeSet<E, N extends CountedRedBlackNode<E>> implements RedBlackTreeSet<E, N> {
		...
		/**
		 * @param theValue The theValue to get the index for
		 * @return The number of values in this set less than the given theValue
		 */
		...
		/**
		 * @param <E> The type of theValue in the set
		...
		public static class NodeSet<E, N extends CountedRedBlackNode<E>> extends RedBlackTreeSet.NodeSet<E, N> {
			 ...
			 * @param min The minimum theValue for the node set
			 * @param minInclusive Whether the node for the minimum theValue is included in the node set
			 * @param max The maximum theValue for the node set
			 * @param maxInclusive Whether the node for the maximum theValue is included in the node set
			 */
	 ...
	 * @param <V> The theValue type of the map
	...
	public static class DefaultTreeSet<E> extends CountedRedBlackTreeSet<E, DefaultNode<E>> {
		...
		/** @param compare The theValue comparator for the set */
	 ...
	 * @param <V> The theValue type for the map
	 */
