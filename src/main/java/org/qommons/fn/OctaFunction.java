...
/**
 * A function that operates on 8 arguments
 * 
 ...
 */
@FunctionalInterface
public interface OctaFunction<A1, A2, A3, A4, A5, A6, A7, A8, R> {
	/**
	 ...
	 */
	R apply(A1 arg1, A2 arg2, A3 arg3, A4 arg4, A5 arg5, A6 arg6, A7 arg7, A8 arg8);
	 ...
	 */
	public static <A1, A2, A3, A4, A5, A6, A7, A8, R> OctaFunction<A1, A2, A3, A4, A5, A6, A7, A8, R> printable(
		OctaFunction<? super A1, ? super A2, ? super A3, ? super A4, ? super A5, ? super A6, ? super A7, ? super A8, ? extends R> function,
	...
	public static <A1, A2, A3, A4, A5, A6, A7, A8, R> OctaFunction<A1, A2, A3, A4, A5, A6, A7, A8, R> printable(
		...
		return new PrintableOctaFn<>(function, print, identity);
	}

	/**
	 * Implements {@link OctaFunction#printable(OctaFunction, String, Object)}
	 * 
	 * @param <A1> The first argument type
	 * @param <A2> The second argument type
	 * @param <A3> The third argument type
	 ...
	 * @param <R> The return type of the function
	 */
	class PrintableOctaFn<A1, A2, A3, A4, A5, A6, A7, A8, R> extends
		FunctionUtils.PrintableLambda<OctaFunction<? super A1, ? super A2, ? super A3, ? super A4, ? super A5, ? super A6, ? super A7, ? super A8, ? extends R>>
		implements OctaFunction<A1, A2, A3, A4, A5, A6, A7, A8, R> {
		public PrintableOctaFn(
			OctaFunction<? super A1, ? super A2, ? super A3, ? super A4, ? super A5, ? super A6, ? super A7, ? super A8, ? extends R> lambda,
		...
		public R apply(A1 arg1, A2 arg2, A3 arg3, A4 arg4, A5 arg5, A6 arg6, A7 arg7, A8 arg8) {
			return getLambda().apply(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8);
		}
	}
}
