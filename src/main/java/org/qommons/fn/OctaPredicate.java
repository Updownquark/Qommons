...
/**
 * A predicate that operates on 8 arguments
 * 
 ...
 */
@FunctionalInterface
public interface OctaPredicate<A1, A2, A3, A4, A5, A6, A7, A8> {
	/**
	 ...
	 */
	public static <A1, A2, A3, A4, A5, A6, A7, A8> OctaPredicate<A1, A2, A3, A4, A5, A6, A7, A8> printable(
		OctaPredicate<? super A1, ? super A2, ? super A3, ? super A4, ? super A5, ? super A6, ? super A7, ? super A8> function,
	...
	public static <A1, A2, A3, A4, A5, A6, A7, A8> OctaPredicate<A1, A2, A3, A4, A5, A6, A7, A8> printable(
		...
		return new PrintableOctaPredicate<>(function, print, identity);
	}

	/**
	 * Implements {@link OctaPredicate#printable(OctaPredicate, String, Object)}
	 * 
	 * @param <A1> The first argument type
	 * @param <A2> The second argument type
	 * @param <A3> The third argument type
	 ...
	 * @param <A5> The fifth argument type
	 * @param <A6> The sixth argument type
	 * @param <A7> The sixth argument type
	 * @param <A8> The eighth argument type
	 */
	class PrintableOctaPredicate<A1, A2, A3, A4, A5, A6, A7, A8> extends
		FunctionUtils.PrintableLambda<OctaPredicate<? super A1, ? super A2, ? super A3, ? super A4, ? super A5, ? super A6, ? super A7, ? super A8>>
		implements OctaPredicate<A1, A2, A3, A4, A5, A6, A7, A8> {
		public PrintableOctaPredicate(
			OctaPredicate<? super A1, ? super A2, ? super A3, ? super A4, ? super A5, ? super A6, ? super A7, ? super A8> lambda,
		...
		public boolean test(A1 arg1, A2 arg2, A3 arg3, A4 arg4, A5 arg5, A6 arg6, A7 arg7, A8 arg8) {
			return getLambda().test(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8);
		}
	}
}
