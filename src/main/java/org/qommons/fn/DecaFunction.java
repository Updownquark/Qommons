...
/**
 * A function that operates on 10 arguments
 * 
 ...
 */
@FunctionalInterface
public interface DecaFunction<A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, R> {
	/**
	 ...
	 * @param <A10> The type of the tenth argument to the function
	 * @param <R> The return type of the function
	 ...
	 */
	public static <A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, R> DecaFunction<A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, R> printable(
		DecaFunction<? super A1, ? super A2, ? super A3, ? super A4, ? super A5, ? super A6, ? super A7, ? super A8, ? super A9, ? super A10, ? extends R> function,
	...
	public static <A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, R> DecaFunction<A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, R> printable(
		...
		return new PrintableDecaFn<>(function, print, identity);
	}

	/**
	 * Implements {@link DecaFunction#printable(DecaFunction, String, Object)}
	 * 
	 * @param <A1> The first argument type
	 * @param <A2> The second argument type
	 * @param <A3> The third argument type
	 ...
	 * @param <R> The return type of the function
	 */
	class PrintableDecaFn<A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, R> extends
		FunctionUtils.PrintableLambda<DecaFunction<? super A1, ? super A2, ? super A3, ? super A4, ? super A5, ? super A6, ? super A7, ? super A8, ? super A9, ? super A10, ? extends R>>
		implements DecaFunction<A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, R> {
		public PrintableDecaFn(
			DecaFunction<? super A1, ? super A2, ? super A3, ? super A4, ? super A5, ? super A6, ? super A7, ? super A8, ? super A9, ? super A10, ? extends R> lambda,
		...
		public R apply(A1 arg1, A2 arg2, A3 arg3, A4 arg4, A5 arg5, A6 arg6, A7 arg7, A8 arg8, A9 arg9, A10 arg10) {
			return getLambda().apply(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10);
		}
	}
}
