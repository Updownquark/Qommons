...
/**
 * A predicate that operates on 10 arguments
 * 
 ...
 * @param <A10> The tenth argument type
 */
@FunctionalInterface
public interface DecaPredicate<A1, A2, A3, A4, A5, A6, A7, A8, A9, A10> {
	/**
	 ...
	 */
	boolean test(A1 arg1, A2 arg2, A3 arg3, A4 arg4, A5 arg5, A6 arg6, A7 arg7, A8 arg8, A9 arg9, A10 arg10);
	 ...
	 * @param <A10> The type of the tenth argument to the predicate
	 ...
	 */
	public static <A1, A2, A3, A4, A5, A6, A7, A8, A9, A10> DecaPredicate<A1, A2, A3, A4, A5, A6, A7, A8, A9, A10> printable(
		DecaPredicate<? super A1, ? super A2, ? super A3, ? super A4, ? super A5, ? super A6, ? super A7, ? super A8, ? super A9, ? super A10> function,
	...
	public static <A1, A2, A3, A4, A5, A6, A7, A8, A9, A10> DecaPredicate<A1, A2, A3, A4, A5, A6, A7, A8, A9, A10> printable(
		...
		return new PrintableDecaPredicate<>(function, print, identity);
	}

	/**
	 * Implements {@link DecaPredicate#printable(DecaPredicate, String, Object)}
	 * 
	 * @param <A1> The first argument type
	 * @param <A2> The second argument type
	 * @param <A3> The third argument type
	 ...
	 * @param <A10> The tenth argument type
	 */
	class PrintableDecaPredicate<A1, A2, A3, A4, A5, A6, A7, A8, A9, A10> extends
		FunctionUtils.PrintableLambda<DecaPredicate<? super A1, ? super A2, ? super A3, ? super A4, ? super A5, ? super A6, ? super A7, ? super A8, ? super A9, ? super A10>>
		implements DecaPredicate<A1, A2, A3, A4, A5, A6, A7, A8, A9, A10> {
		public PrintableDecaPredicate(
			DecaPredicate<? super A1, ? super A2, ? super A3, ? super A4, ? super A5, ? super A6, ? super A7, ? super A8, ? super A9, ? super A10> lambda,
		...
		@Override
		public boolean test(A1 arg1, A2 arg2, A3 arg3, A4 arg4, A5 arg5, A6 arg6, A7 arg7, A8 arg8, A9 arg9, A10 arg10) {
			return getLambda().test(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10);
		}
	}
}
