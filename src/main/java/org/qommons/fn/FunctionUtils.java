...
public class FunctionUtils {
	...
	/** The {@link FunctionUtils#getIdentifier(Object) identifier} representing the identity function */
	...
	public static final Comparator<Comparable<?>> COMPARABLE_COMPARE = FunctionUtils.<Comparable<?>> printableComparator(//
	 ...
	 */
	public static <T> BetterSupplier<T> alwaysNull() {
		return (BetterSupplier<T>) NULL;
	}
	 ...
	 */
	public static <T, X> BetterFunction<T, X> constantFn(X value) {
	 ...
	 * @return A function that always returns the given value
	 */
	public static <T, X> BetterFunction<T, X> constantFn(X value, String print, Object identifier) {
	 ...
	 * @return A function that always returns the given value
	 */
	public static <T, X> BetterFunction<T, X> constantFn(X value, Supplier<String> print, Object identifier) {
	 ...
	 * @return A function that always returns the given value
	 */
	public static <T, V, X> BetterBiFunction<T, V, X> constantBiFn(X value, String print, Object identifier) {
	 ...
	 */
	public static <T> BetterSupplier<T> printableSupplier(Supplier<T> supplier, Supplier<String> print, Object identifier) {
	 ...
	 * @return A supplier that always returns the given value
	 */
	public static <T> BetterSupplier<T> constantSupplier(T value, String print, Object identifier) {
	 ...
	 * @return A supplier that always returns the given value
	 */
	public static <T> BetterSupplier<T> constantSupplier(T value, Supplier<String> print, Object identifier) {
	 ...
	 * @return A supplier that always returns the given value
	 */
	public static <T> BetterSupplier<T> constantSupplier(T value) {
	 ...
	 */
	public static <T> BetterSupplier<T> cachingSupplier(Supplier<T> impl) {
	 ...
	 */
	public static <T, X> BetterFunction<T, X> printableFn(Function<T, X> fn, String print, Object identifier) {
		if (fn == null)
			return null;
	 ...
	 * @return The printable function
	 */
	public static <T, X> BetterFunction<T, X> printableFn(Function<T, X> fn, Supplier<String> print) {
		if (fn == null)
			return null;
	 ...
	 * @return The printable function
	 */
	public static <T, X> BetterFunction<T, X> printableFn(Function<T, X> fn, Supplier<String> print, Object identifier) {
		if (fn == null)
			return null;
	 ...
	 * @return The printable function
	 */
	public static <T, U, X> BetterBiFunction<T, U, X> printableBiFn(BiFunction<T, U, X> fn, String print, Object identifier) {
		if (fn == null)
			return null;
	 ...
	 * @return The printable function
	 */
	public static <T, U, X> BetterBiFunction<T, U, X> printableBiFn(BiFunction<T, U, X> fn, Supplier<String> print, Object identifier) {
		if (fn == null)
			return null;
	 ...
	 */
	public static <T, U, X> BetterBiFunction<T, U, X> toBiFunction1(Function<? super T, ? extends X> map) {
		if (map == null)
			return null;
	 ...
	 * @return The binary function
	 */
	public static <T, U, X> BetterBiFunction<T, U, X> toBiFunction2(Function<? super U, ? extends X> map) {
		if (map == null)
			return null;
	...
	/** An interface recognized by the {@link FunctionUtils} class which can report whether or not its operation is trivial */
	...
	static class PrintableRunnable extends PrintableLambda<Runnable> implements Runnable {
		...
		public boolean isTrivial() {
			return FunctionUtils.isTrivial(theLambda);
		}
	}
	...
	static class PrintableConsumer<T> extends PrintableLambda<Consumer<T>> implements Consumer<T> {
		...
		public Consumer<T> andThen(Consumer<? super T> after) {
			...
			else if (after instanceof LambdaUtility && ((LambdaUtility) after).isTrivial())
				return this;
			else
				return new CombinedConsumer<>(this, after);
		}

		static class CombinedConsumer<T> implements Consumer<T> {
			private final Consumer<? super T>[] theComponents;

			public CombinedConsumer(Consumer<? super T>... components) {
				theComponents = components;
			}

			@Override
			public void accept(T t) {
				for (Consumer<? super T> component : theComponents)
					component.accept(t);
			}

			@Override
			public int hashCode() {
				return Objects.hashCode(theComponents);
			}
			...
			public boolean equals(Object obj) {
				if (this == obj)
					return true;
				else if (!(obj instanceof CombinedConsumer))
					return false;
				CombinedConsumer<?> other = (CombinedConsumer<?>) obj;
				return Arrays.equals(theComponents, other.theComponents);
			}
	...
	static class PrintableSupplier<T> extends PrintableLambda<Supplier<T>> implements BetterSupplier<T> {
	...
	static class CachingSupplier<T> implements BetterSupplier<T> {
	...
	static class PrintableFunction<T, X> extends PrintableLambda<Function<T, X>> implements BetterFunction<T, X> {
	...
	static class PrintableBiFunction<T, U, X> extends PrintableLambda<BiFunction<T, U, X>> implements BetterBiFunction<T, U, X> {
	...
	static class MappedBiFunction1<T, U, X> implements BetterBiFunction<T, U, X>, LambdaUtility {
		...
		@Override
		public boolean isTrivial() {
			return FunctionUtils.isTrivial(theMap);
		}
	...
	static class MappedBiFunction2<T, U, X> implements BetterBiFunction<T, U, X> {
