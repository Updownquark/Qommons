...
public class ArgumentParsing {
    ...
    public interface ArgumentDefCreator {
         ...
         *            The name of the argument
         * @param pattern
         *            The pattern that the values of the argument must match
         * @return The new argument definition
         */
     ...
     * 
     * @param <A>
     *            The sub-type of the argument definition
     */
    public interface ArgumentDef<A extends ArgumentDef<A>> extends ArgumentDefCreator, ArgumentPatternCreator {
         ...
         * 
         * @param min
         *            The minimum number of times the argument can occur
         * @param max
         *            The maximum number of times the argument can occur
        ...
        /**
         * @param constraint
         *            The constraint to add to this definition
         * @return This definition, for chaining
         */
         ...
         * 
         * @param targetArgName
         *            The name of the target argument
         * @return This definition, for chaining
         */
         ...
         *            The name of the target argument
         * @param targetValue
         *            The value for the target argument
         * @return This definition, for chaining
         */
         ...
         * @param targetArgName
         *            The name of the target argument
         * @param targetValueCheck
         *            The value check for the target argument
         * @return This definition, for chaining
         */
         ...
         *             If one or more arguments in the set violate constraints defined in this argument definition
         */
        ...
        /**
         * @param matcher
         *            The matcher from the pattern that parsed this argument
         * @param value
         *            The argument's value text
         * @param parsed
         *            The arguments parsed so far
         * @param moreArgs
         *            Subsequent arguments in the argument list
         * @return The parsed argument
         * @throws IllegalArgumentException
         *             If the value text cannot be parsed according to this definition's expectations
         */
        Argument parse(Matcher matcher, String value, Arguments parsed, Queue<String> moreArgs) throws IllegalArgumentException;
    }
    ...
    public static class ArgumentConstraint{
         ...
         * 
         * @param arg
         *            The argument whose presence is constrained
         * @param target
         *            The argument whose presence determines if this constraint's argument is required or forbidden
         * @param argReq
         *            Whether this constraint's argument is required or forbidden if the target argument condition is met
         * @param targetReq
         *            Whether the target argument's presence or absence satisfies the target condition
         */
         ...
         *            The argument whose presence determines if this constraint's argument is required or forbidden
         * @param targetValue
         *            The value that is checked for the target argument condition
         * @param argReq
         *            Whether this constraint's argument is required or forbidden if the target argument condition is met
         * @param targetReq
         *            Whether the target argument's value must match or not match the target value to satisfy the target condition
         */
         ...
         *            The argument whose presence determines if this constraint's argument is required or forbidden
         * @param targetValueCheck
         *            The value check for the target argument condition
         * @param argReq
         *            Whether this constraint's argument is required or forbidden if the target argument condition is met
         * @param targetReq
         *            Whether the target argument's value must pass or fail the target value check to satisfy the target condition
         */
         ...
         * @param value
         *            The value expected for the argument, or null if the value is not to be checked against a specific value
         * @param test
     ...
     * @param <A>
     *            The sub-type of this argument definition
     */
    public interface ValuedArgumentDef<T, A extends ValuedArgumentDef<T, A>> extends ArgumentDef<A> {
         ...
         * 
         * @param valueCheck
         *            The test for this argument's value
         * @param targetArgName
         *            The name of the target argument
         * @return This definition, for chaining
         */
         ...
         *            The name of the target argument
         * @param targetValue
         *            The value for the target argument if this argument has the given value
         * @return This definition, for chaining
         */
         ...
         *            The name of the target argument
         * @param targetValueCheck
         *            The value check that the target argument's value must pass if this argument has the given value
         * @return This definition, for chaining
         */
         ...
         * 
         * @param valueCheck
         *            The value check for this argument's value
         * @param targetArgName
         *            The name of the target argument
         * @param targetValue
         *            The value for the target argument if this argument's value passes the given test
         * @return This definition, for chaining
         */
         ...
         *            The name of the target argument
         * @param targetValueCheck
         *            The value check that the target argument's value must pass if this argument's value passes its test
         * @return This definition, for chaining
         */
         ...
         *            The name of the target argument
         * @param targetValue
         *            The forbidden value for the target argument if this argument has the given value
         * @return This definition, for chaining
         */
         ...
         *            The name of the target argument
         * @param targetValueCheck
         *            The value check that the target argument's value must fail if this argument has the given value
         * @return This definition, for chaining
         */
         ...
         *            The name of the target argument
         * @param targetValue
         *            The forbidden value for the target argument if this argument's value passes the given test
         * @return This definition, for chaining
         */
         ...
         *            The name of the target argument
         * @param targetValueCheck
         *            The value check that the target argument's value must fail if this argument's value passes its test
         * @return This definition, for chaining
         */
         ...
         * 
         * @param value
         *            The value for this argument if the target argument is present
         * @param targetArgName
         *            The name of the target argument
         * @return This definition, for chaining
         */
         ...
         * 
         * @param valueCheck
         *            The check that this argument's value must pass if the target argument is present
         * @param targetArgName
         *            The name of the target argument
         * @return This definition, for chaining
         */
         ...
         * 
         * @param value
         *            The value for this argument if the target argument's value matches the value given for it
         * @param targetArgName
         *            The name of the target argument
         * @param targetValue
         *            The value for the target argument
         ...
         * 
         * @param value
         *            The value for this argument if the target argument's value passes the given test
         * @param targetArgName
         *            The name of the target argument
         * @param targetValueCheck
         *            The value check for the target argument
         ...
         * 
         * @param valueCheck
         *            The check that this argument's value must pass if the target argument's value matches the value given for it
         * @param targetArgName
         *            The name of the target argument
         * @param targetValue
         *            The value for the target argument
         ...
         * 
         * @param valueCheck
         *            The check that this argument's value must pass if the target argument's value passes the test given for it
         * @param targetArgName
         *            The name of the target argument
         * @param targetValueCheck
         *            The value check for the target argument
         ...
         * 
         * @param value
         *            The forbidden value for this argument if the target argument is present
         * @param targetArgName
         *            The name of the target argument
         * @return This definition, for chaining
         */
         ...
         * 
         * @param valueCheck
         *            The check that this argument's value must fail if the target argument is present
         * @param targetArgName
         *            The name of the target argument
         * @return This definition, for chaining
         */
         ...
         * 
         * @param value
         *            The forbidden value for this argument if the target argument's value matches the value given for it
         * @param targetArgName
         *            The name of the target argument
         * @param targetValue
         *            The value for the target argument
         ...
         * 
         * @param value
         *            The forbidden value for this argument if the target argument's value passes the given test
         * @param targetArgName
         *            The name of the target argument
         * @param targetValueCheck
         *            The value check for the target argument
         ...
         * 
         * @param valueCheck
         *            The check that this argument's value must fail if the target argument's value matches the value given for it
         * @param targetArgName
         *            The name of the target argument
         * @param targetValue
         *            The value for the target argument
         ...
         * 
         * @param valueCheck
         *            The check that this this argument's value must fail if the target argument's value passes the test given for it
         * @param targetArgName
         *            The name of the target argument
         * @param targetValueCheck
         *            The value check for the target argument
         ...
         * 
         * @param constraint
         *            The test that the value of arguments of this type must pass
         * @return This definition, for chaining
         */
         ...
         *            The name for the constraint in error messages
         * @param constraint
         *            The test that the value of arguments of this type must pass
         * @return This definition, for chaining
         */
         ...
         * 
         * @param values
         *            The possible values for arguments of this type
         * @return This definition, for chaining
         */
        A only(T... values);
        ...
        /**
         * @param defValue
         *            The value that this argument will have if the argument is not specified in the argument list
         * @return This definition, for chaining
         */
        A defValue(T defValue);
        /**
         * @param defCreator
         *            Dynamically supplies the value for this argument if it is not specified in the argument list
         * @return This definition, for chaining
         */
        ...
        @Override
        default Argument parse(Matcher matcher, String value, Arguments parsed, Queue<String> moreArgs) {
            return createArgument(matcher, parse(value, parsed));
        }
         ...
         */
        Argument createArgument(Matcher matcher, T value);

        /**
         * Parses the value of an argument of this type from text
         * 
         * @param value
         *            The value text for the argument
         * @param parsed
         *            The arguments parsed so far
    ...
    public interface ComparableArgumentDef<T extends Comparable<T>, A extends ComparableArgumentDef<T, A>> extends ValuedArgumentDef<T, A> {
        /**
         * @param min
         *            The minimum value for arguments of this type
         * @return This definition, for chaining
         */
        A atLeast(T min);
        /**
         * @param max
         *            The maximum value for arguments of this type
         * @return This definition, for chaining
         */
        A atMost(T max);
        /**
     ...
     * 
     * @param <T>
     *            The type of the value of the argument to constrain
     */
    public static class ArgumentValueConstraint<T> extends ArgumentConstraint {
         ...
         * 
         * @param arg
         *            The argument to constraint
         * @param argValue
         *            The value for the argument
         * @param target
         *            The name of the target argument
         * @param argReq
         *            Whether this constraint's argument must match or not match the given value if the target argument condition is met
         * @param targetReq
         *            Whether the target argument's presence or absence satisfies the target condition
         */
         ...
         *            The argument to constraint
         * @param argValueCheck
         *            The value check for the argument
         * @param target
         *            The name of the target argument
         * @param argReq
         *            Whether this constraint's argument must pass or fail the given test if the target argument condition is met
         * @param targetReq
         *            Whether the target argument's value must pass or fail the target value check to satisfy the target condition
         */
    ...
    private static abstract class ValuedArgumentDefImpl<T, A extends ValuedArgumentDefImpl<T, A>> extends ArgumentDefImpl<A> implements
        ...
        protected ValuedArgumentDefImpl(ArgumentPattern pattern, String name) {
            ...
            if (pattern != null && !pattern.isWithValue()) {
                throw new IllegalArgumentException("Valued arguments cannot be used by un-valued patterns (\"" + getName() + "\")");
            }
    ...
    public static class FlagArgumentDef extends ArgumentDefImpl<FlagArgumentDef> {
        ...
        /**
         * @param pattern
         *            The argument pattern that this argument is for
         * @param name
         ...
         * 
         * @param subArgsParser
         *            The parser to parse sub-arguments for this argument
         * @return This definition, for chaining
         */
         ...
         * 
         * @param subArgs
         *            An argument definition belonging to an argument parser to parse sub-arguments for this argument
         * @return This definition, for chaining
         */
        ...
        @Override
        public Argument parse(Matcher matcher, String value, Arguments parsed, Queue<String> moreArgs) {
            Arguments subArgs = null;
            if (theSubArgParser != null) {
                subArgs = theSubArgParser.parse(moreArgs, false);
            }
            return new FlagArgument(this, matcher, subArgs);
        }
    ...
    public static class StringArgumentDef extends ValuedArgumentDefImpl<String, StringArgumentDef> {
        ...
        @Override
        public Argument createArgument(Matcher matcher, String value) {
    ...
    public static class PatternArgumentDef extends ValuedArgumentDefImpl<String, PatternArgumentDef> {
         ...
         *            This argument's name
         * @param pattern
         *            The pattern that values of this argument must obey
         */
    ...
    public static class IntArgumentDef extends ComparableArgumentDefImpl<Long, IntArgumentDef> {
        ...
        @Override
        public Argument createArgument(Matcher matcher, Long value) {
            return new ValuedArgument<>(this, matcher, value);
        }
    ...
    public static class FloatArgumentDef extends ComparableArgumentDefImpl<Double, FloatArgumentDef> {
        ...
        @Override
        public Argument createArgument(Matcher matcher, Double value) {
            return new ValuedArgument<>(this, matcher, value);
        }
     ...
     * 
     * @param <E>
     *            The enumeration type of this argument
     */
    public static class EnumArgumentDef<E extends Enum<E>> extends ComparableArgumentDefImpl<E, EnumArgumentDef<E>> {
        ...
        @Override
        public Argument createArgument(Matcher matcher, E value) {
            return new ValuedArgument<>(this, matcher, value);
        }
    ...
    public static class BooleanArgumentDef extends ValuedArgumentDefImpl<Boolean, BooleanArgumentDef> {
        ...
        @Override
        public Argument createArgument(Matcher matcher, Boolean value) {
            return new ValuedArgument<>(this, matcher, value);
        }
    ...
    public static class FileArgumentDef extends ValuedArgumentDefImpl<File, FileArgumentDef> {
        ...
        @Override
        public Argument createArgument(Matcher matcher, File value) {
            return new ValuedArgument<>(this, matcher, value);
        }
         ...
         * 
         * @param dir
         *            Whether the value of this argument must be a directory or a file
         * @return This definition, for chaining
         */
        ...
        public FileArgumentDef relativeTo(File relative) {
            if (theRelativeFileArg != null) {
                throw new IllegalArgumentException("The relativeTo(File) and relativeTo(String arg) methods are exclusive"
         ...
         * 
         * @param otherFileArgument
         *            The name of the file argument whose value will be used as a relative directory
         * @return This definition, for chaining
         */
    ...
    private static abstract class ArgumentImpl implements Argument{
        ...
        protected ArgumentImpl(ArgumentDef<?> def, Matcher matcher) {
            theDefinition=def;
            theMatcher = matcher;
        }
    ...
    public static class ValuedArgument<T> extends ArgumentImpl {
        ...
        /**
         * @param def
         *            The argument definition of this argument
         * @param matcher
         *            The matcher from the pattern that parsed this argument
         * @param value
         *            The value for this argument
         */
        public ValuedArgument(ValuedArgumentDef<T, ?> def, Matcher matcher, T value) {
            super(def, matcher);
            theValue = value;
        }
    ...
    public static class FlagArgument extends ArgumentImpl {
         ...
         *            The matcher from the pattern that parsed this argument
         * @param subArgs
         *            The sub-arguments for this argument
         */
        public FlagArgument(FlagArgumentDef def, Matcher matcher, Arguments subArgs) {
            super(def, matcher);
            theSubArgs = subArgs;
        }
    ...
    public static class UnmatchedArgument extends ArgumentImpl {
        private static class UnmatchedArgumentDef extends ArgumentDefImpl<UnmatchedArgumentDef> {
            ...
            @Override
            public Argument parse(Matcher matcher, String value, Arguments parsed, Queue<String> moreArgs) throws IllegalArgumentException {
                return new UnmatchedArgument(this, matcher);
            }
        }

        private UnmatchedArgument(UnmatchedArgumentDef def, Matcher matcher) {
            super(def, matcher);
        }

        /**
         * @param pattern
         *            The pattern that matched this argument, or null if the argument was not pattern-matched
         * @param matcher
         *            The matcher from the pattern that parsed this argument, or null if this argument was not pattern-matched
         * @param name
         *            This argument's name, or the entire argument text if the pattern is null.
         * @return The new argument
         */
        public static UnmatchedArgument create(ArgumentPattern pattern, Matcher matcher, String name) {
            return new UnmatchedArgument(new UnmatchedArgumentDef(pattern, name), matcher);
        }
    }
    ...
    public static class UnmatchedValuedArgument extends ValuedArgument<String> {
        private static class UnmatchedValuedArgumentDef extends ValuedArgumentDefImpl<String, UnmatchedValuedArgumentDef> {
            ...
            @Override
            public Argument createArgument(Matcher matcher, String value) {
                return new UnmatchedValuedArgument(this, matcher, value);
            }
        ...
        private UnmatchedValuedArgument(UnmatchedValuedArgumentDef def, Matcher matcher, String value) {
            super(def, matcher, value);
        }

        /**
         * @param pattern
         *            The pattern that matched this argument
         * @param matcher
         *            The matcher from the pattern that parsed this argument
         * @param name
         *            The name of the argument
         ...
         * @return The new argument
         */
        public static UnmatchedValuedArgument create(ArgumentPattern pattern, Matcher matcher, String name, String value) {
            return new UnmatchedValuedArgument(new UnmatchedValuedArgumentDef(pattern, name), matcher, value);
        }
    }
    ...
    public static class Arguments {
        ...
        /**
         * @param parser
         *            The parser that parsed this argument set
         */
         ...
         * @throws IllegalArgumentException
         *             If no argument with the given name was acceptable to this argument set's parser
         */
        ...
        /**
         * @param argDef
         *            The argument definition to get arguments of
        ...
        /**
         * @param patternName
         *            The name of the pattern to get the arguments for
        ...
        public List<Argument> forPattern(String patternName) {
            ...
            return theArguments
                    .stream()
                    .filter(arg -> arg.getDefinition().getArgPattern() != null
                            && arg.getDefinition().getArgPattern().getName().equals(patternName)).collect(Collectors.toList());
        }
        ...
        /**
         * @param arg
         *            The argument to add to this argument set
         */
    ...
    public static interface ArgumentPatternCreator {
         ...
         * 
         * @param pattern
         *            The pattern to match arguments with
         * @return The pattern
         */
         ...
         *            The pattern to match arguments with
         * @param withName
         *            Whether arguments matching this pattern will have individual names. If true, the pattern must have a capturing group
         *            for the name. This can be a capturing group named "name" or the first capturing group.
         * @param withValue
         *            Whether arguments matching this pattern have a value. If true, the pattern must have a capturing group for the value.
         *            This can be a capturing group named "value", the first capturing group (if <code>withName</code> is false), or the
         *            second capturing group (if <code>withName</code> is true).
         * @param multiValues
         *            Whether the pattern supports multiple values in a single argument
         * @return The pattern
         */
        default ArgumentPattern forPattern(String name, Pattern pattern, boolean withName, boolean withValue, boolean multiValues) {
            return getParser().forPattern(name, pattern, withName, withValue, multiValues);
        }
        ...
        default ArgumentPattern forDefaultValuePattern() {
            return forValueOnlyPattern("value", Pattern.compile("(.+)"));
        }
        // TODO There seems to be a bug in the regex with a capturing group within a non-capturing group, so these multi-value
    ...
    public static class ArgumentPattern implements ArgumentPatternCreator, ArgumentDefCreator {
        private final ArgumentParser theParser;
        private final String theName;
        private final Pattern thePattern;
        ...
        /**
         * @param parser
         *            The argument parser that this pattern belongs to
         * @param name
         *            The name of the pattern for later recall
         * @param pattern
         *            The regular expression that this pattern will use to parse arguments
         * @param withName
         *            Whether this pattern's arguments are named individually
         * @param withValue
         *            Whether this pattern's arguments have values
         * @param multiValue
         *            Whether this pattern supports multiple values for a single argument
         */
        public ArgumentPattern(ArgumentParser parser, String name, Pattern pattern, boolean withName, boolean withValue, boolean multiValue) {
            theParser=parser;
            theName=name;
            thePattern=pattern;
            hasName = withName;
         ...
         * @throws IllegalArgumentException
         *             If this pattern is misconfigured
         */
        protected List<Argument> parse(String arg, Arguments parsed, Queue<String> moreArgs) throws IllegalArgumentException {
            ...
            if (hasValue && !isMultiValue) {
                groups++;
            }
            if (match.groupCount() < groups) {
                throw new IllegalArgumentException("Argument pattern \"" + theName + "\" (" + thePattern.pattern()
                        + ") does not have enough capturing groups."
            ...
            if (match.groupCount() == 1) {
                ...
                if (match.groupCount() == groups || isMultiValue) {
                    ...
                    try {
                        ...
                        throw new IllegalArgumentException("Argument pattern \"" + theName + "\" (" + thePattern.pattern()
                                + ") has more than " + groups + " group" + (groups > 1 ? "s" : "")
                                + " and does not possess groups named \"name\" and \"value\".");
                    }
                }
            }
            if(argValues==null) {
            ...
            List<Argument> ret = new ArrayList<>(argValues.length);
            for (int i = 0; i < argValues.length; i++) {
                ...
                if (argName != null) {
                    ...
                    if (argDef != null) {
                        found = true;
                        ret.add(argDef.parse(match, argValues[i], parsed, moreArgs));
                    }
                } else {
                ...
                if (found) {
                } else if (isAcceptingUnmatched) {
                    if (argValues[i] == null) {
                        ret.add(UnmatchedArgument.create(this, match, argName));
                    } else {
                        ret.add(UnmatchedValuedArgument.create(this, match, argName, argValues[i]));
                    }
                } else if (i == 0) {
                    return null;
                } else {
                    throw new IllegalArgumentException("Parsed first value in multi-values but could not parse subsequent? " + arg);
                }
            }
            return ret;
        }
            ...
            for (ArgumentDef<?> arg : theAcceptedArguments.values()) {
                if (arg instanceof ValuedArgumentDef) {
                    if (args.getArguments(arg).isEmpty()) {
                        ...
                        if (def != null) {
                            args.add(((ValuedArgumentDef) arg).createArgument(null, def));
                        }
                    }
                }
            }
    ...
    public static class ArgumentParser implements ArgumentPatternCreator {
        ...
        /**
         * @param print
         *            Whether this parser should print an argument usage text to standard out and then exit the process if
        ...
        @Override
        public ArgumentPattern forPattern(String name, Pattern pattern, boolean withName, boolean withValue, boolean multiValues) {
            for (ArgumentPattern p : theArgPatterns) {
                if(p.getName().equals(name)) {
                    if (!p.getPattern().equals(pattern)) {
                        throw new IllegalArgumentException("Cannot have 2 different patterns with the same name: " + name + " ("
                                + p.getPattern() + " and " + pattern + ")");
                    }
                    return p;
                }
            }
            ArgumentPattern ret = new ArgumentPattern(this, name, pattern, withName, withValue, multiValues);
         ...
         * @throws IllegalArgumentException
         *             If an error occurs parsing an argument or an argument constraint is violated
         */
        public Arguments parse(String... args) throws IllegalArgumentException {
            return parse(new ArrayDeque<>(Arrays.asList(args)));
        }
         ...
         *            The command-line arguments to parse
         * @param completely
         *            If false, this parser will only parse as many arguments
         * @return The parsed argument set
         * @throws IllegalArgumentException
         *             If an error occurs parsing an argument or an argument constraint is violated
         */
            ...
            while (!args.isEmpty()) {
                ...
                if (!found) {
                    if (isAcceptingUnmatched) {
                        ret.add(UnmatchedArgument.create(null, null, arg));
                    } else if (completely) {
        ...
        public String toString(){
            ...
            for(ArgumentPattern pattern : theArgPatterns){
                ret.append("For pattern ").append(pattern.getPattern()).append(":\n");
     ...
     * 
     * @param args
     *            Command-line arguments, ironically ignored
     */
    public static void main(String[] args) {
        ...
        /*    */.flagArg("wait-for-user")
        /*    */.flagArg("with-subs")
        /*        */.sub(new ArgumentParser()
        /*        */.forDefaultValuePattern()
        /*            */.intArg("int-sub1").times(1, 1)
        /*            */.intArg("int-sub2")
        /*            */.stringArg("string-sub"));

        Arguments arguments;
        try {
            arguments = argParser.parse("--all-projects", "--op=clean-build,jar", "--lookup=..", "--lookup=../../libs",
                    "--dest=export.jar", "--encoding=cp1252", "--wait-for-user", "--with-subs", "0", "sub", "--mf:property1=value1");
